...
char* XMLProcessor::copyElementContentLevel(const char*xml   ,
    ...
    openTag      = false;
    closeTag     = false;
//    printf("openbracket:%d, closeBracket:%d, preCloseBracket:%d, openTag:%d,closeTag:%d", openBracket, closeBracket, preCloseBracket, openTag, closeTag);
    return ret;
