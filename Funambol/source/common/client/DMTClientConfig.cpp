...
bool DMTClientConfig::readConnConfig(ManagementNode& /* syncMLNode */,
    ...
    accessConfig.setProxyPort((int)strtol(tmp, NULL, 10));
    delete [] tmp;
    ...
    accessConfig.setResponseTimeout((int)strtol(tmp, NULL, 10));
    delete [] tmp;
...
bool DMTClientConfig::readExtDevConfig(ManagementNode& /* syncMLNode */,
    ...
    if(server){
        ...
        clientConfig.setMaxObjSize((int)strtol(tmp, NULL, 10));
        delete [] tmp;
